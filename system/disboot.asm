...
00007C04  E80200            call 0x7c09
00007C07  EBFE              jmp short 0x7c07
00007C09  B81C7C            mov ax,0x7c1c
00007C0C  89C5              mov bp,ax
00007C0E  B91000            mov cx,0x10
00007C11  B80113            mov ax,0x1301
00007C14  BB0C00            mov bx,0xc
00007C17  B200              mov dl,0x0
00007C19  CD10              int 0x10
00007C1B  C3                ret
00007C1C  48                dec ax
00007C1D  656C              gs insb
00007C1F  6C                insb
00007C20  6F                outsw
00007C21  2C20              sub al,0x20
00007C23  4F                dec di
00007C24  53                push bx
00007C25  20776F            and [bx+0x6f],dh
00007C28  726C              jc 0x7c96
00007C2A  640000            add [fs:bx+si],al
